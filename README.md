...
This repository contains two tutorials used for Sherpiades 2024
...
To work on this tutorial, you should go to the "Fraix" directory
...
If you have problem, ask Didier (and bring some chocolate)!



# Neural network tutorial (Geoff)

To work on this tutorial, you should go to the "Lesur" directory
